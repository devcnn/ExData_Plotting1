...
#Plot(1,1)
plot(data$DateTime,data$Global_active_power,col="black",ylab="Global Active Power (kilowatts)",xlab="",type="n")
...
#Plot(1,2)
plot(data$DateTime,data$Voltage,col="black",ylab="Voltage",xlab="datetime",type="n")
lines(data$DateTime,data$Voltage)

#Plot(2,2)
plot(data$DateTime,data$Global_reactive_power,col="black",ylab="Global_reactive_power",xlab="datetime",type="n")
